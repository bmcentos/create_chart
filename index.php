...
<body style="padding: 5rem;">
 <header>
    ...
    <form method="POST" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>">
        <label class="black-font" for="app">App Name:</label><br>
        <input class="left-align" type="text" name="app" id="app" value="cerc-app"><br><br>

        <label class="black-font" for="namespace">Namespace:   </label><br>
        <input class="left-align" type="text" name="namespace" id="namespace" value="cerc"><br><br>
        
        <label  class="black-font" for="containerPort">Container Port:</label><br>
        <input class="left-align" type="text" name="containerPort" id="containerPort" value="8080"><br><br>
...
<button id="download-button" class="hidden">Download Charts</button>
  ...
  function exibirMensagem() {
    ...
    if (!is_dir($directory)) {
	   ...
	   $mensagem = '[+] values.yaml atualizado!!!';
...
?>
	...
	<h1> Preview</h1>
        <?php
        $yamlContent = file_get_contents('charts/environments/stg/values.yaml');

        // Exibir o conteúdo dentro de uma tag <textarea>
        echo '<textarea readonly rows="50" cols="100">' . htmlspecialchars($yamlContent) . '</textarea>';
        ?>
    </div>
</body>
